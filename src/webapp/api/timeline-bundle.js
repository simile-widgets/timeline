...
this._syncWithBandOrthogonalScrollHandler=function(H){A._onHighlightBandOrthogonalScroll();
};
...
this._dragX=A.clientX;
this._dragY=A.clientY;
if(this._timeline.isHorizontal()){this._moveEther(C,B);
}else{this._moveEther(B,C);
}this._positionHighlight();
this._showScrollbar();
}};
...
}if(this._supportsOrthogonalScrolling){this._viewOrthogonalOffset=this._viewOrthogonalOffset+B;
...
var G=Math.round(-this._viewOrthogonalOffset*E)+"px";
...
}A.defaultStackIcon="icon" in this._params.stackConcurrentPreciseInstantEvents?this._params.stackConcurrentPreciseInstantEvents.icon:A.defaultIcon;
A.defaultStackIconWidth="iconWidth" in this._params.stackConcurrentPreciseInstantEvents?this._params.stackConcurrentPreciseInstantEvents.iconWidth:A.defaultIconWidth;
A.defaultStackIconHeight="iconHeight" in this._params.stackConcurrentPreciseInstantEvents?this._params.stackConcurrentPreciseInstantEvents.iconHeight:A.defaultIconHeight;
return A;
};
