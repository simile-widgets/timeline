...
this._viewOrthogonalOffset=Math.min(0,this._viewOrthogonalOffset+B);
...
Timeline.CompactEventPainter.prototype._setOrthogonalOffset=function(A){var B=2*A.trackOffset+this._tracks.length*A.trackHeight;
var D=Math.min(0,this._band.getViewWidth()-B);
var C=Math.max(D,this._band.getViewOrthogonalOffset());
this._highlightLayer.style.top=this._lineLayer.style.top=this._eventLayer.style.top=C+"px";
};
...
Timeline.OriginalEventPainter.prototype._setOrthogonalOffset=function(A){var B=2*A.trackOffset+this._tracks.length*A.trackIncrement;
var D=Math.min(0,this._band.getViewWidth()-B);
var C=Math.max(D,this._band.getViewOrthogonalOffset());
this._highlightLayer.style.top=this._lineLayer.style.top=this._eventLayer.style.top=C+"px";
};
