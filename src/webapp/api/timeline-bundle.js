...
var W=this._paintEventLabel(N,L,M,R,F.width,F.height,X,G);
var T=N.getColor();
...
this._createHighlightDiv(U,C,X);
...
var T=this._paintEventLabel(K,I,J,O,C.width,C.height,U,D);
var L=this;
...
this._createHighlightDiv(R,B,U);
this._eventIdToElmt[K.getID()]=B.elmt;
this._tracks[M]=F;
};
...
var Y=this._paintEventLabel(M,K,L,R,C.width,C.height,Z,D);
var N=this;
...
this._createHighlightDiv(W,B,Z);
this._eventIdToElmt[M.getID()]=B.elmt;
this._tracks[P]=I;
};
...
Timeline.OriginalEventPainter.prototype._paintEventLabel=function(J,K,C,G,A,I,F,D){var H=this._timeline.getDocument();
var B=H.createElement("div");
B.className=D;
B.style.left=C+"px";
B.style.width=A+"px";
...
}var E=J.getTextColor();
if(E==null){E=J.getColor();
}if(E!=null){B.style.color=E;
}this._eventLayer.appendChild(B);
return{left:C,top:G,width:A,height:I,elmt:B};
};
...
Timeline.OriginalEventPainter.prototype._getLabelDivClassName=function(A){var B=A.getClassName();
return"timeline-event-label"+(B!=null?(" "+B):"");
};
...
this.autoWidth=A&&A[0]&&A[0].theme&&A[0].theme.autoWidth;
this.autoWidthAnimationTime=A&&A[0]&&A[0].theme&&A[0].theme.autoWidthAnimationTime;
this._initialize();
};
