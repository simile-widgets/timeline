...
}var A=this._eventPainter.getType()=="overview"?this._theme.event.overviewTrack.autoWidthMargin:this._theme.event.track.autoWidthMargin;
var B=Math.ceil((this._eventTracksNeeded+A)*this._eventTrackIncrement);
var C=this._bandInfo;
if(B!=null&&B>C.width){C.width=B;
